  ...
  return (
    <motion.header
      className="fixed md:sticky w-full z-[999] bottom-0 md:top-0 h-[4.5rem] rounded-none border bg-secondary md:bg-opacity-80 text-stone-700 md:shadow-black/[0.10] 
        md:backdrop-blur-[0.5rem] sm:h-[4rem] sm:rounded-md dark:bg-stone-800 dark:md:bg-white/10 dark:border-white/5 dark:md:bg-opacity-80"
      ...
      <nav className="flex justify-center items-center h-full">
        <ul className="flex flex-wrap items-center justify-center gap-y-1 w-full sm:w-[initial] sm:flex-nowrap gap-10">
          {links.map((link) => (
            ...
            >
              <a
                className={`p-2 hover:text-stone-950 transition-all duration-300 ease-in-out dark:text-stone-200 flex items-center gap-x-3 justify-center relative hover:bg-stone-100 dark:hover:text-stone-800 dark:hover:bg-stone-500 rounded ${
              ...
              >
                <i className="text-xl" aria-hidden="false">
                  {link.icon}
                </i>
