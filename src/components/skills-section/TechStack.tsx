...
export default function TechStack() {
  return (
    <div className="flex flex-col col-span-2 row-span-3 bg-secondary border-b md:border-0 py-6 px-8 md:rounded-md gap-y-6 dark:bg-white/10 dark:border-white/5">
